...
const NAV = [
  ...
  { href: "/admin/campaigns", label: "Campaigns", live: false },
  { href: "/admin/crm", label: "Subscriber CRM", live: false },
  { href: "/admin/analytics", label: "Analytics", live: false },
  { href: "/admin/compliance", label: "Compliance", live: false },
];
